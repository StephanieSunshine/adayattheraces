...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { bets: @race.bets, contestants: @race.contestants, finish_order: @race.finish_order, purse: @race.purse, runtime: @race.runtime }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { bets: @race.bets, contestants: @race.contestants, finish_order: @race.finish_order, purse: @race.purse, runtime: @race.runtime }
    assert_redirected_to race_path(assigns(:race))
  end
