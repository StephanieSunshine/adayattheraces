...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { amount: @bet.amount, bid: @bet.bid, finish_position: @bet.finish_position, hid: @bet.hid, paid: @bet.paid, rid: @bet.rid }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { amount: @bet.amount, bid: @bet.bid, finish_position: @bet.finish_position, hid: @bet.hid, paid: @bet.paid, rid: @bet.rid }
    assert_redirected_to bet_path(assigns(:bet))
  end
